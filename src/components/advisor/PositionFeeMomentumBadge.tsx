...
export default function PositionFeeMomentumBadge({ poolId }: { poolId?: string }) {
  ...
  return (
    <div className={`text-[11px] ${color}`} title="7d fee momentum">
      Fees {arrow} {trend.pct.toFixed(1)}%
    </div>
  );
}
