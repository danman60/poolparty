...
export default function PoolsHeaderFeeMomentum({ poolId }: { poolId: string }) {
  ...
  return (
    <div className={`text-sm ${color}`} title="7d fee momentum">Fees {arrow} {trend.pct.toFixed(1)}%</div>
  );
}
